...
from config_SANet_GCC import cfg
# from config_SANet_BN_SHHB import cfg
...
class Trainer():
    def __init__(self, dataloader, cfg_data, pwd):
        ...
        if self.net_name in ['SANet'] or self.net_name in ['SANet_BN']:
        ...
        self.writer, self.log_txt = logger(self.exp_path, self.exp_name, self.pwd, 'exp', resume=cfg.RESUME,cfg=cfg)
...
#                     print(name)
    ...
    def validate_V1(self):# validate_V1 for SHHA, SHHB, UCF-QNRF, UCF50
        ...
        print_summary(self.log_txt,self.exp_name,[mae, mse, loss],self.train_record)
    ...
    def validate_V2(self):# validate_V2 for WE
        ...
        print_summary(self.log_txt,self.exp_name,[mae, 0, loss],self.train_record)
