...
defaultcfg = {
    ...
    'VGG_unpruned':[64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512, 128, 128, 64, 32, 1]

}
class VGG_decoder_bn(nn.Module):
    def __init__(self, pretrained=False):
        super(VGG_decoder_bn, self).__init__()
        vgg = models.vgg16_bn(pretrained=pretrained)
        # if pretrained:
        #     vgg.load_state_dict(torch.load(model_path))
        features = list(vgg.features.children())
        self.features4 = nn.Sequential(*features[0:33])
