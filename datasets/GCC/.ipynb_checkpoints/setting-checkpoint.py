...
__C_GCC.TRAIN_SIZE = (480,848)#GCC

__C_GCC.DATA_PATH = '../ProcessedData/GCC'
# __C_GCC.DATA_PATH = '../GCC'
...
# __C_GCC.TRAIN_BATCH_SIZE = 12 #imgs
__C_GCC.TRAIN_BATCH_SIZE = 6 #imgs

# __C_GCC.VAL_BATCH_SIZE = 16 #
__C_GCC.VAL_BATCH_SIZE = 6 #
# __C_GCC.VAL_BATCH_SIZE = 8 #
