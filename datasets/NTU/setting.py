...
__C_NTU.VAL_MODE = 'cycleGAN' # Options:normal,density,normal_ab_only,normal_ssc_only,density_ssc_only,density_ab_only,normal_train_ab_test_ssc,normal_train_ssc_test_ab,density_train_ssc_test_ab,density_train_ab_test_ssc,hall_DA
