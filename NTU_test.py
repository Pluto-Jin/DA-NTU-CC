...
parser.add_argument('--save', default='/home/jinc0008/ntu_random_test_pred', type=str, metavar='PATH',help='path to save prune model (default: current directory)')
parser.add_argument('--test-dir', default='/export/home/jinc0008/ntu_random_test/', type=str, metavar='PATH',help='path to save prune model (default: current directory)')
...
for folder,file in zip(file_folder,file_name):
    plt.figure()
    imagename='/home/jinc0008/'+ folder + '/'+ file + '.png'
