...
__C.PRE_GCC_MODEL = './05-ResNet-50_all_ep_35_mae_32.4_mse_76.1.pth' # path to model
...
__C.EXP_PATH = './exp/Res50_SHHB' # the path of logs, checkpoints, and current codes
